...
A medical application for tracking exams and parameters, based on the latest technology stack: PHP 8.4 and Symfony 8.0.7.
...
Aplikacja medyczna do śledzenia badań oraz parametrów, oparta o najnowszy stack technologiczny PHP 8.4 i Symfony 8.0.7.
